({
    //getConListCall
    getAccdetails : function(component,event,helper,callback2) {
    ...
    //getOppListCall
    getCondetails : function(component,event,helper,callback3) {
    ...
    getOppdetails : function(component,event,helper,callback1) {
